...
const BASE_URL = `${import.meta.env.VITE_SERVER_BASE_URL}/auth/login`
        ...
        <>
            ...
            >
                <div className="w-full text-base md:text-lg">
                    ...
                    <input
                        type="text"
                        className="border-2 outline-none w-full px-2 py-2 rounded-[10px] bg-[#455561] text-white md:py-4"
